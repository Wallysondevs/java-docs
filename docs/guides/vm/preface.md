...
Este documento fornece informações sobre os recursos suportados pela tecnologia Java Virtual Machine.

### Público-alvo

Este documento é destinado a desenvolvedores experientes que criam aplicações usando a tecnologia Java HotSpot.
...
---|---
negrito | O tipo negrito indica elementos de interface gráfica do usuário associados a uma ação, ou termos definidos no texto.
