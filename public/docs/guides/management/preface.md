...
A Plataforma Java, Standard Edition 25 (Java SE 25) fornece utilitários que permitem monitorar e gerenciar o desempenho de uma Java Virtual Machine (Java VM) e das aplicações Java que estão sendo executadas nela. O Guia de Monitoramento e Gerenciamento do Java SE descreve esses utilitários de monitoramento e gerenciamento.
...
O acesso e uso dos serviços de suporte Oracle por parte dos clientes Oracle estarão em conformidade com os termos e condições especificados em seu pedido Oracle para os serviços aplicáveis.
