...
O Guia de Instalação do Java Platform, Standard Edition descreve como instalar o Java Development Kit (JDK) em computadores Linux, Microsoft Windows e macOS.

### Público-alvo

Este documento é destinado a usuários que estão instalando qualquer variante da plataforma Java SE.
...
Consulte a [Documentação do JDK 25](<#/>).
...
`monoespaçado` | O tipo monoespaçado indica comandos dentro de um parágrafo, URLs, código em exemplos, texto que aparece na tela ou texto que você insere.